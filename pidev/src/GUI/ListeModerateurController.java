...
@FXML
  ...
  stage.show();
    ...
    private void UpdateRecord1() {
        ...
        String req = " UPDATE Personne SET nom ='" + tfnom.getText() + "', prenom ='" + tfprenom.getText() + "', dateNaissance ='" + java.sql.Date.valueOf(tfdatenaissance.getValue()) + "' , email = '" + tfemail.getText() + "', telephone= '" + tftelephone.getText() + "', password ='" + tfpassword.getText() + "' WHERE id_personne = '" + tfidmoderateur.getText() + "'";
        executeQuery(req);
